...
<a href="{{ route('admin.categories_state.edit', $model) }}" class="btn btn-warning">Edit</a>
...
<button href="{{ route('admin.categories_state.destroy', $model) }}" class="btn btn-danger" id="delete">Hapus</button>
