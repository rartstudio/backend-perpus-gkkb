...
<a href="{{ route('admin.categories_book.edit', $model) }}" class="btn btn-warning">Edit</a>
...
<button href="{{ route('admin.categories_book.destroy', $model) }}" class="btn btn-danger" id="delete">Hapus</button>
