...
<a href="{{ route('admin.categories_book.edit', $model) }}" class="btn btn-warning"><i class="fas fa-pencil-alt">
</i></a>
...
<button href="{{ route('admin.categories_book.destroy', $model) }}" class="btn btn-danger" id="delete"><i class="fas fa-trash-alt">
</i></button>
