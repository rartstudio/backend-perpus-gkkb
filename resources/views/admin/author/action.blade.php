...
<a href="{{ route('admin.authors.edit', $model) }}" class="btn btn-warning">Edit</a>
...
<button href="{{ route('admin.authors.destroy', $model) }}" class="btn btn-danger" id="delete">Hapus</button>
