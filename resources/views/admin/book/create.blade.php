        ...
        <div class="box-body">
            <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" id="title" class="form-control @error('cbo_name') border border-danger @enderror" placeholder="Ketikkan judul buku">
                </div>
                <div class="form-group">
                    <label for="description">Deskripsi</label>
                    <input type="text" name="description" id="description" class="form-control @error('description') border border-danger @enderror" placeholder="Ketikkan deskripsi buku">
                    @error('description')
                        <span class="form-text text-red">
                            {{ $message }}
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="qty" id="qty" class="form-control @error('qty') border border-danger @enderror" placeholder="Ketikkan deskripsi buku">
                    @error('qty')
                        <span class="form-text text-red">
                            {{ $message }}
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="cover" id="cover" class="form-control @error('cover') border border-danger @enderror" placeholder="Ketikkan deskripsi buku">
                    @error('cover')
                        <span class="form-text text-red">
                            {{ $message }}
                        </span>
