...
<a href="{{ route('admin.books.edit', $model) }}" class="btn btn-warning">Edit</a>
...
<button href="{{ route('admin.books.destroy', $model) }}" class="btn btn-danger" id="delete">Hapus</button>
